      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="min-w-0">
            ...
            <h3 className="mt-2 text-lg font-semibold text-secondary-900 sm:text-xl">
              Affinez votre pige
            </h3>
            <p className="mt-1 text-sm text-secondary-500">
              Gardez la recherche rapide visible, ouvrez les filtres avancés seulement quand nécessaire.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-secondary-700 shadow-sm transition hover:bg-gray-50"
            >
        ...
        {showAdvanced && (
          <div className="space-y-4 rounded-3xl border border-gray-200 bg-slate-50/70 p-4 sm:p-5">
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-[1.1fr_1fr_0.9fr]">
              ...
              <div className="rounded-2xl border border-dashed border-primary-200 bg-white/80 px-4 py-3">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-primary-700">
                  Mode avancé
                </p>
                <p className="mt-1 text-sm text-secondary-600">
                  Tous les filtres détaillés sont regroupés ici pour alléger la page.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4 rounded-3xl border border-gray-200 bg-white p-4 lg:grid-cols-4">
              <div>
